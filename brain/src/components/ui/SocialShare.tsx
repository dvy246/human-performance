      ...
      <div className="w-full flex flex-col gap-3 mt-4 border-t border-card-border/40 pt-4">
        ...
        <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-3 h-8 rounded border border-accent/30 bg-accent/5 hover:bg-accent/15 text-accent hover:text-accent text-xs font-mono transition-standard active:scale-95 cursor-pointer"
          >
          ...
          <button
            onClick={handleCopy}
            className="flex items-center gap-1.5 px-3 h-8 rounded border border-card-border bg-subtle/50 hover:bg-panel text-muted hover:text-foreground text-xs font-mono transition-standard active:scale-95 cursor-pointer"
          >
          ...
          <a
            ...
            className="flex items-center gap-1.5 px-3 h-8 rounded border border-card-border bg-subtle/50 hover:bg-panel text-muted hover:text-foreground text-xs font-mono transition-standard active:scale-95"
          >

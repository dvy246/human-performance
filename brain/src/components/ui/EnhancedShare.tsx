...
export default function EnhancedShare({
  ...
  const shareText =
    text ||
    `I scored ${score || "great"} on ${testType || "this"} at CogniArena! Can you beat me?`
      ...
      <div className="flex flex-wrap gap-2">
        {canShare && (
          <button
            ...
            className="flex items-center gap-2 rounded-md bg-accent px-3 py-2 text-xs font-medium text-white transition-opacity hover:opacity-90"
          >
            <svg
        ...
        <button
          ...
          className={`flex items-center gap-2 rounded-md border px-3 py-2 text-xs font-medium transition-colors ${
            copied
              ...
              : "border-card-border text-muted hover:bg-subtle hover:text-foreground"
          }`}
        >
          {copied ? (
            <>
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-md border border-card-border px-3 py-2 text-xs font-medium text-muted transition-colors hover:bg-subtle hover:text-foreground"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="14"

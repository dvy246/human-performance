...
const questions: CQQuestion[] = [
  {
    ...
    choices: [
      ...
      { text: 'Reading or listening to detailed explanations', style: 'verbal' },
      { text: 'Breaking it down into step-by-step logic', style: 'analytical' },
      { text: 'Getting the big picture first, then filling in details', style: 'holistic' },
    ],
  },
  {
    prompt: 'When solving a problem, you tend to:',
    choices: [
      { text: 'Picture the solution in your mind before acting', style: 'visual' },
      { text: 'Talk through the problem out loud or write it down', style: 'verbal' },
  ...
  },
  {
    ...
    choices: [
      { text: 'Saw them in an image, video, or demonstration', style: 'visual' },
      { text: 'Heard them explained or discussed them', style: 'verbal' },
      { text: 'Understood the underlying rules and structure', style: 'analytical' },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Explain your reasoning with words and examples', style: 'verbal' },
      { text: 'Point out logical flaws or inconsistencies', style: 'analytical' },
      { text: 'Synthesize different viewpoints into a shared vision', style: 'holistic' },
    ],
  },
  {
    ...
    choices: [
      ...
      { text: 'Read the instructions or listen to a walkthrough', style: 'verbal' },
      { text: 'Follow a structured curriculum with clear milestones', style: 'analytical' },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Quiet space for reading, writing, and discussion', style: 'verbal' },
      { text: 'Spreadsheets, structured data, and clear processes', style: 'analytical' },
      { text: 'Collaborative open space with room for brainstorming', style: 'holistic' },
    ],
  },
  {
    ...
    choices: [
      ...
      { text: 'I think in systems, rules, and logical sequences', style: 'analytical' },
      { text: 'I think in concepts, connections, and overarching themes', style: 'holistic' },
    ],
  },
];

const styleData: Record<Style, { label: string; icon: string; desc: string; strengths: string[] }> = {
  visual: {
    ...
    strengths: ['Spatial reasoning', 'Pattern recognition', 'Design intuition', 'Mind mapping'],
  },
  verbal: {
    ...
    strengths: ['Written expression', 'Vocabulary recall', 'Argumentation', 'Explaining concepts'],
  },
  analytical: {
    ...
    strengths: ['Critical thinking', 'Systematic problem solving', 'Data analysis', 'Logical reasoning'],
  },
  holistic: {
    ...
    strengths: ['Big-picture thinking', 'Synthesizing ideas', 'Strategic insight', 'Creativity'],
  },
};
...
export default function CognitiveStyleQuiz() {
  ...
  const [scores, setScores] = useState<Record<Style, number>>({ visual: 0, verbal: 0, analytical: 0, holistic: 0 });
  ...
  if (phase === 'result') {
    const sorted = (Object.entries(scores) as [Style, number][]).sort((a, b) => b[1] - a[1]);
    ...
    return (
      <div className="flex flex-col gap-8 py-8 max-w-lg mx-auto w-full">
        <div className="text-center flex flex-col items-center gap-3">
          ...
          <h2 className="text-2xl font-bold text-foreground tracking-tight">{data.label}</h2>
        </div>
        ...
        <div className="flex flex-col gap-3">
          <h3 className="text-sm font-bold text-foreground tracking-tight">Your Style Breakdown</h3>
  ...
  return (
    <div className="flex flex-col gap-6 py-6 max-w-xl mx-auto w-full">
      ...
      <div className="flex flex-col gap-4 p-5 rounded-xl border border-card-border bg-subtle">
        <p className="text-sm text-foreground font-medium leading-relaxed">{q.prompt}</p>

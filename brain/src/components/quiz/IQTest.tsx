    ...
    <div className="flex flex-col items-center gap-1">
      <svg width={w} height={h}>
        {Array.from({ length: cols * rows }).map((_, i) => {
          ...
          const filledIdx = filled.findIndex(
            ([fx, fy]) => fx === i % cols && fy === Math.floor(i / cols)
          )
          return (
            <rect
              key={i}
...
const questions: Question[] = [
  ...
  },
  {
    ...
    correctIndex: 3,
    explanation:
      "This is the Fibonacci sequence. Each term is the sum of the previous two. 5 + 8 = 13.",
  },
  {
    id: 5,
    domain: "numerical",
  ...
  // VERBAL
  {
    ...
    correctIndex: 1,
    explanation:
      "The sound a dog makes is a bark; the sound a cat makes is a meow.",
  },
  {
    id: 7,
    domain: "verbal",
    ...
    correctIndex: 2,
    explanation:
      "A collection of trees forms a forest. A collection of stars forms a galaxy.",
  },
  {
    id: 8,
    domain: "verbal",
    ...
    correctIndex: 1,
    explanation:
      "Optimistic and pessimistic are opposites. The opposite of generous is stingy.",
  },
  {
    id: 9,
    domain: "verbal",
    ...
    correctIndex: 1,
    explanation:
      "An oculist specializes in eye health. A podiatrist specializes in foot health.",
  },
  {
    id: 10,
    domain: "verbal",
    ...
    correctIndex: 1,
    explanation:
      "Ephemeral (short-lived) is opposite to permanent. Nascent (newly emerging) is opposite to developed.",
  },
  ...
  // SPATIAL
  {
    ...
    prompt: (
      <div className="flex flex-col items-center gap-2">
        <span className="text-sm">
          Which option shows the L-shape rotated 90° clockwise?
        </span>
        <GridShape
          filled={[
            [0, 0],
    ...
    correctIndex: 0,
    explanation:
      "Rotating the L-shape 90° clockwise places the two-block vertical column on the right.",
  },
  {
    id: 12,
    domain: "spatial",
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <div className="grid grid-cols-2 gap-1">
          ...
          <GridShape
            ...
            label=""
          />
          <span className="flex h-10 w-10 items-center justify-center text-lg text-secondary">
            ?
          </span>
        </div>
      </div>
    ...
    correctIndex: 2,
    explanation:
      "The pattern rotates the L-shape 90° clockwise in each cell. The missing cell needs a shape with the long arm pointing left and down.",
  },
  {
    id: 13,
    domain: "spatial",
    ...
    prompt: (
      <div className="flex flex-col items-center gap-2">
        <span className="text-sm">
          Which shape is the mirror image of this one?
        </span>
        <GridShape
          filled={[
            [0, 0],
    ...
    correctIndex: 1,
    explanation:
      "A mirror image flips horizontally. The protruding cell at the right end of the top row flips to the left end of the top row.",
  },
  {
    id: 14,
    domain: "spatial",
    ...
    prompt: (
      <div className="flex flex-col items-center gap-2">
        ...
        <div className="grid grid-cols-3 gap-[2px] rounded bg-card-border p-[2px]">
          <div />
          <div className="h-8 w-8 rounded bg-foreground/80" />
          <div />
          <div />
          <div className="h-8 w-8 rounded bg-foreground/80" />
          <div />
    ...
    correctIndex: 1,
    explanation:
      "The cross-shaped net (a center row of 3 squares with one above and one below the middle) is the classic net that folds into a cube.",
  },
  {
    id: 15,
    domain: "spatial",
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <MatrixOption
            ...
            label=""
          />
          <span className="flex items-center justify-center text-2xl text-secondary">
            ?
          </span>
        </div>
      </div>
    ...
    correctIndex: 2,
    explanation:
      "Each cell in the 2×2 grid contains a diagonal line pattern. The bottom-right cell should complete the diagonal from top-left to bottom-right.",
  },
  ...
  // LOGICAL
  {
    ...
    correctIndex: 1,
    explanation:
      "If all mammals breathe air and whales are mammals, then whales must breathe air (deductive syllogism).",
  },
  {
    id: 17,
    domain: "logical",
    ...
    correctIndex: 1,
    explanation:
      "Affirming the consequent is a logical fallacy. Wet ground could result from sprinklers, a spill, or rain — we cannot conclude it rained.",
  },
  {
    id: 18,
    domain: "logical",
    difficulty: "medium",
    prompt:
      "Five people are standing in line. Alex is ahead of Blake. Blake is ahead of Casey. Dana is behind Casey but ahead of Evan. Who is last?",
    options: ["Alex", "Casey", "Dana", "Evan"],
    correctIndex: 3,
    explanation:
      "The order is: Alex, Blake, Casey, Dana, Evan. Evan is last in line.",
  },
  {
    id: 19,
    domain: "logical",
    ...
    correctIndex: 3,
    explanation:
      'If A is a knight, B must be a knight (truth). But then B saying "we are different" is a lie — contradiction. So A is a knave, meaning "B is a knight" is false, so B is also a knave. B says "we are different" — false, since they are the same. Consistent. Both are knaves.',
  },
  {
    id: 20,
    domain: "logical",
    ...
    correctIndex: 1,
    explanation:
      "If all squares are rectangles and no rhombuses are rectangles, then squares (being rectangles) cannot be rhombuses.",
  },
]
...
export default function IQTest() {
    ...
    return (
      <div className="mx-auto flex max-w-lg flex-col items-center gap-6 py-8 text-center">
        ...
        <h2 className="text-2xl font-bold tracking-tight text-foreground">
          Free Cognitive Reasoning Quiz
        </h2>
        <div className="flex flex-col gap-2 text-sm leading-relaxed text-muted">
          <p>
            20 questions across{" "}
            <strong className="text-foreground">
              numerical, verbal, spatial, and logical
            </strong>{" "}
            reasoning domains.
          </p>
          <p>No time limit. No sign-up. All scoring happens in your browser.</p>
          <p className="text-xs text-secondary">
            Based on formats from the International Cognitive Ability Resource
            (ICAR).
          </p>
        </div>
        <div className="flex flex-wrap justify-center gap-3 text-xs">
          {(["numerical", "verbal", "spatial", "logical"] as Domain[]).map(
            (d) => (
              <span
                className={`rounded-full border border-card-border bg-subtle px-2.5 py-1 ${domainColors[d]} font-medium`}
              >
  ...
  if (phase === "result") {
    const rawScore = answers
      .filter((a) => a !== null)
      .reduce((sum, a, i) => sum + (a === questions[i].correctIndex ? 1 : 0), 0)
    const { iq, percentile } = computeIQ(rawScore)
    const label = getIQLabel(iq)
    const domainScores = (
      ["numerical", "verbal", "spatial", "logical"] as Domain[]
    ).map((d) => {
      const qs = questions.filter((q) => q.domain === d)
      const correct = qs.filter(
        (q) => answers[q.id - 1] === q.correctIndex
      ).length
      return {
        domain: d,
        correct,
    ...
    return (
      <div className="mx-auto flex w-full max-w-lg flex-col gap-8 py-8">
        ...
        <div className="flex flex-col items-center gap-2 rounded-xl border border-card-border bg-subtle p-6">
          <span
            className={`text-5xl font-extrabold tracking-tight ${label.color}`}
          >
            {iq}
          </span>
          ...
          <span className="text-xs text-muted">
            Top {percentile < 1 ? "<1" : percentile}th percentile
          </span>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            {domainScores.map(({ domain, correct, total, pct }) => (
              <div
                key={domain}
                className="flex flex-col gap-1.5 rounded-lg border border-card-border bg-subtle p-3"
              >
                <span
                  className={`text-xs font-semibold ${domainColors[domain]}`}
                >
                  {domainLabels[domain].split(" ")[0]}
                </span>
                <div className="h-2 w-full overflow-hidden rounded-full bg-card-border">
                  <div
                    className={`h-full rounded-full transition-all ${domainColors[domain].replace("text-", "bg-")}`}
                    style={{ width: `${pct}%` }}
                  />
                </div>
                <span className="text-xs text-muted">
        ...
        <div className="flex flex-col gap-3 rounded-xl border border-card-border bg-subtle p-4 text-xs leading-relaxed text-muted">
          <p>
            <strong className="text-foreground">Note:</strong> This is an
            informal cognitive reasoning quiz for entertainment and
            self-educational purposes only. It is not a clinically validated IQ
            assessment. Scores are estimates based on a 20-question sample and
            should not be treated as a professionally administered cognitive
            evaluation. For a comprehensive assessment, consult a licensed
            psychologist.
          </p>
        </div>
  ...
  return (
    <div className="mx-auto flex w-full max-w-xl flex-col gap-6 py-6">
      <div className="flex items-center justify-between text-xs text-muted">
        ...
        <span className={`font-medium ${domainColors[q.domain]}`}>
      ...
      <div className="flex flex-col gap-4 rounded-xl border border-card-border bg-subtle p-5">
        <div className="text-sm leading-relaxed font-medium whitespace-pre-line text-foreground">
          {q.prompt}
        </div>
          ...
          {q.options.map((opt, i) => {
            ...
            return (
              <button
                ...
                className={`transition-standard flex items-center gap-3 rounded-lg border p-3 text-left text-sm ${borderClass} ${showExplanation ? "cursor-default" : "cursor-pointer"}`}
              >
                ...
                {selected && !isCorrect && (
                  <span className="ml-auto text-xs font-semibold text-error">
                    &times;
                  </span>
                )}
              </button>
        ...
        {showExplanation && (
          <div
            className={`rounded-lg p-3 text-xs leading-relaxed ${isCorrect ? "border border-[var(--success-border)] bg-[var(--success-bg)] text-secondary" : "border border-[var(--error-border)] bg-[var(--error-bg)] text-secondary"}`}
          >

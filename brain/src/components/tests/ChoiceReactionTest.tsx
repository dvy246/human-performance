          ...
          <div className="flex flex-col items-center gap-4">
            <div className="flex flex-col items-center gap-0.5">
              ...
              <span className="text-accent text-xs font-mono uppercase">
                {formatTopPercentile(lookupPercentile('choice-reaction', Math.round(attempts.reduce((sum, item) => sum + item.score, 0) / totalAttempts.current), true), true)} globally
              </span>
            </div>

...
export const STAGE_CONFIGS: StageConfig[] = [
  {
    ...
    description: "Find the target among distractions",
    emoji: "🎯",
    duration: "~30s",
  },
  {
    ...
    description: "Ignore fake notifications",
    emoji: "🛡️",
    duration: "~30s",
  },
  {
    index: 2,
    name: "Task Switching",
    description: "Switch between rules rapidly",
    emoji: "🔄",
    duration: "~40s",
  },
  {
  ...
  {
    index: 4,
    name: "WM Under Distraction",
    description: "Remember sequences through noise",
    emoji: "🧠",
    duration: "~45s",
  },
]

...
export const PERSONAS: Record<keyof CognitiveAverages, Persona> = {
  reaction: {
    ...
    explanation:
      "You excel at rapid visual and auditory response triggers. Your motor responses are tuned for fast reflexes.",
  },
  memory: {
    title: "Pattern Hunter",
    desc: "Visuospatial Chunking Planner",
    explanation:
      "You group sequence coordinates and structural matrices into spatial memory blocks, recalling longer sequences by organizing items into meaningful chunks.",
  },
  processing: {
    title: "Choice Strategist",
    desc: "Fast Choice Strategist",
    explanation:
      "You maintain fast visual choice-decision paths. When faced with multiple choices, you resolve selection paths cleanly.",
  },
  precision: {
    title: "Precision Targeter",
    desc: "Spatial Motor Coordinator",
    explanation:
      "You execute fine target adjustments with high accuracy, gliding to target boundaries with minimal coordinate offset errors.",
  },
  focus: {
    title: "Focus Guardian",
    desc: "Impulse Control Specialist",
    explanation:
      "You display excellent reaction pacing and target discrimination, ignoring distractor stimuli and maintaining high accuracy.",
  },
  stamina: {
    title: "Stamina Specialist",
    desc: "Endurance Clicker",
    explanation:
      "You maintain highly consistent click cadences. Your motor execution displays high resilience against fatigue and speed degradation.",
  },
}
...
export const CHALLENGE_POOL: DailyChallenge[] = [
  {
    ...
    target: 240,
    condition: "lower",
    desc: "Record a reaction score below 240 ms.",
  },
  {
    testId: "click-speed",
    ...
    target: 8.5,
    condition: "higher",
    desc: "Achieve click speed cadence of 8.5 CPS or higher.",
  },
  {
    testId: "aim-trainer",
    name: "Aim Precision",
    ...
    target: 92,
    condition: "higher",
    desc: "Complete Aim Precision with 92% accuracy or higher.",
  },
  {
    ...
    target: 7,
    condition: "higher",
    desc: "Reach Level 7 or higher in Sequence Memory.",
  },
  {
    testId: "go-no-go",
    name: "Color Go/No-Go",
    ...
    target: 360,
    condition: "lower",
    desc: "Complete Go/No-Go under 360 ms average.",
  },
  {
    ...
    target: 200,
    condition: "lower",
    desc: "Record sound reaction below 200 ms.",
  },
  {
    ...
    target: 450,
    condition: "lower",
    desc: "Complete Choice Grid under 450 ms.",
  },
  {
    testId: "f1-lights",
    ...
    target: 230,
    condition: "lower",
    desc: "Launch start lights below 230 ms.",
  },
  {
    testId: "stroop",
    name: "Stroop Attention",
    metric: "ms",
    target: 800,
    condition: "lower",
    desc: "Complete Stroop color clash under 800 ms final average score.",
  },
  {
    ...
    target: 6000,
    condition: "higher",
    desc: "Achieve 6,000 Points or higher in Pattern Reasoning.",
  },
  {
    testId: "tmt-partA",
    name: "Trail Making A",
    ...
    target: 30000,
    condition: "lower",
    desc: "Complete Trail Making Part A under 30.0 seconds.",
  },
  {
    testId: "tmt-partB",
    name: "Trail Making B",
    ...
    target: 55000,
    condition: "lower",
    desc: "Complete Trail Making Part B under 55.0 seconds.",
  },
  {
    testId: "dual-n-back",
    name: "Dual N-Back Memory",
    metric: "Pts",
    target: 3000,
    condition: "higher",
    desc: "Achieve 3,000 Points or higher in Dual N-Back.",
  },
  {
    testId: "typing-speed",
    name: "Typing Speed",
    ...
    target: 60,
    condition: "higher",
    desc: "Type 60 WPM or higher in the Typing Speed Test.",
  },
]
...
export function getAdaptiveRecommendations(
  avg: CognitiveAverages
): Recommendation[] {
  const recs: Recommendation[] = []
  const categories: Array<{
    id: keyof CognitiveAverages
    testId: string
    label: string
    link: string
  }> = [
    ...
    },
    {
      ...
      label: "Aim Coordination",
      link: "/tests/aim-coordination",
    },
    {
      id: "memory",
      testId: "dual-n-back",
      label: "Dual N-Back Memory",
      link: "/tests/dual-n-back",
    },
    {
      id: "processing",
      testId: "pattern-reasoning",
      label: "Pattern Reasoning",
      link: "/tests/pattern-reasoning",
    },
    {
      id: "precision",
      testId: "aim-trainer",
      label: "Aim Precision",
      link: "/tests/aim-trainer",
    },
    {
      id: "focus",
      testId: "trail-making",
